        ...
        <div className="p-5">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 dark:text-white text-base">{booking.building}</h3>
          ...
          <div className="space-y-3 mb-4 bg-gray-50/80 dark:bg-gray-900/30 rounded-xl p-3.5 border border-gray-200/50 dark:border-gray-800/50">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">{booking.day}</span>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="p-1.5 bg-gradient-to-br from-cyan-500 to-cyan-600 dark:from-cyan-400 dark:to-cyan-500 rounded-lg shadow-sm">
                <Clock className="w-3.5 h-3.5 text-white" strokeWidth={2.5} />
              </div>
              <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">{booking.time}</span>
            </div>
            <div className="flex items-center gap-2.5">
              <div className="p-1.5 bg-gradient-to-br from-cyan-500 to-cyan-600 dark:from-cyan-400 dark:to-cyan-500 rounded-lg shadow-sm">
              ...
              <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">
                {booking.machines || 1} {booking.machines === 1 ? "Machine" : "Machines"}
              </span>
            </div>
            {booking.weight && (
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">{booking.weight}</span>
              </div>
            )}
            {booking.comment && (
              <div className="flex items-start gap-2.5 pt-2 border-t border-gray-200/50 dark:border-gray-800/50">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">{booking.comment}</p>
              </div>
            )}
          </div>
          ...
          {booking.adminComment && (
            <div className="px-3.5 py-3 bg-amber-50/80 dark:bg-amber-900/10 border-2 border-amber-200 dark:border-amber-800/50 rounded-xl">
              <div className="flex items-start gap-2.5">
                <div className="p-1.5 bg-gradient-to-br from-amber-500 to-amber-600 dark:from-amber-400 dark:to-amber-500 rounded-lg shadow-sm flex-shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-amber-800 dark:text-amber-300 leading-relaxed">{booking.adminComment}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="pt-4 border-t-2 border-gray-200/50 dark:border-gray-800/50">
            <div className={`flex items-center gap-2 px-3 py-1.5 ${statusConfig.bgColor} rounded-lg border ${statusConfig.borderColor} w-fit`}>
              <StatusIcon
                ...
                strokeWidth={2.5}
              />
              <span className={`text-xs font-semibold ${statusConfig.textColor} uppercase tracking-wide`}>
                {statusConfig.text}
              </span>
            </div>
